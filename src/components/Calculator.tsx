...
export const Calculator: React.FC = () => {
  ...
  const [expression, setExpression] = useState<string>('');kjjjj
  ...
  return (
    <div
      id="app-wrapper"
      className={`min-h-screen w-full flex flex-col items-center justify-center p-4 sm:p-6 transition-colors duration-300 select-none ${isDark ? 'bg-[#0a0a0a] text-neutral-200' : 'bg-neutral-100 text-neutral-900'
        }`}
    >
      <motion.div
        ...
        className={`w-full max-w-[400px] rounded-[36px] sm:rounded-[40px] p-6 sm:p-8 shadow-2xl transition-all duration-300 border backdrop-blur-md ${isDark
      ...
      >
        ...
        <div className="flex items-center justify-between mb-6 sm:mb-8 px-1">
          <div className="flex items-center gap-2.5">
            <span className={`text-[10px] tracking-[0.2em] font-semibold uppercase ${isDark ? 'text-neutral-500' : 'text-neutral-400'
              }`}>
              Precision v1.0
            </span>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={`p-2 rounded-xl transition-all duration-200 relative ${isDark
                ? 'text-neutral-400 hover:text-neutral-200 hover:bg-neutral-800/80'
                : 'text-neutral-600 hover:text-neutral-900 hover:bg-neutral-100'
                }`}
        ...
        >
          ...
          <button
            id="copy-result-btn"
            onClick={handleCopy}
            className={`absolute -top-6 right-1 p-1 rounded-md opacity-0 group-hover:opacity-100 focus:opacity-100 transition-opacity text-xs flex items-center gap-1 ${isDark ? 'text-neutral-500 hover:text-orange-400' : 'text-neutral-400 hover:text-orange-600'
              }`}
          ...
          <div className="h-6 flex items-center justify-end text-right overflow-hidden mb-1">
            <span className={`text-sm font-mono tracking-wider transition-colors ${isDark ? 'text-neutral-500' : 'text-neutral-400'
              }`}>
              {expression || '\u00A0'}
            </span>
          </div>
        ...
        <div className="grid grid-cols-4 gap-3 sm:gap-4">
          ...
          <button
            id="btn-clear"
            onClick={handleClear}
            className={`h-14 sm:h-16 rounded-2xl flex items-center justify-center text-xl font-medium transition-all active:scale-95 ${isDark
          ...
          <button
            ...
            className={`h-14 sm:h-16 rounded-2xl flex items-center justify-center text-2xl font-medium transition-all active:scale-95 text-white ${operation === '÷' && !overwrite
          ...
          <button
            ...
            className={`h-14 sm:h-16 rounded-2xl flex items-center justify-center text-2xl font-light transition-all active:scale-95 ${isDark
          ...
          <button
            ...
            className={`h-14 sm:h-16 rounded-2xl flex items-center justify-center text-lg transition-all active:scale-95 ${isDark
          ...
          <button
            ...
            className={`h-14 sm:h-16 rounded-2xl flex items-center justify-center text-2xl font-bold transition-all active:scale-95 ${isDark
        ...
        <div className={`mt-5 pt-3 border-t text-center text-xs flex items-center justify-center gap-1.5 ${isDark ? 'border-neutral-800/60 text-neutral-500' : 'border-neutral-200 text-neutral-400'
          }`}>
          <span>Bàn phím:</span>
      ...
      <div className={`mt-8 sm:mt-10 text-[11px] tracking-widest uppercase flex items-center gap-4 ${isDark ? 'text-neutral-600' : 'text-neutral-400'
        }`}>
